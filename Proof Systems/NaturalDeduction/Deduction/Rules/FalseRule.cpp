...
FalseRule::FalseRule(RuleResult result, std::vector<std::shared_ptr<Formula>> &&premises): Rule(LogicOperation::FALSE, result, std::move(premises))
{

}

int FalseRule::getRuleArgumentCountIntroduction() const
{
    return 1;
}

int FalseRule::getRuleArgumentCountElimination() const
{
    return 1;
}
