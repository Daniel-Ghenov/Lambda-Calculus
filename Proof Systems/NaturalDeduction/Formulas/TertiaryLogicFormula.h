...
public:
    TertiaryLogicFormula(Formula *main, Formula *left, Formula *right) : LogicFormula(LogicOperation::SUBSTITUTION, FormulaType::TERTIARY_LOGIC),
    ...
    [[nodiscard]] Formula *getMain() const { return main.get(); }
    [[nodiscard]] Formula *getLeft() const { return left.get(); }
    [[nodiscard]] Formula *getRight() const { return right.get(); }
